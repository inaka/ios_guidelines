...
*Examples*: [horizontal spacing](src/horizontalSpacing.m)    
...
*Examples*: [vertical spacing](src/verticalSpacing.m)    
...
*Examples*: [pragma marks](src/pragmaMarks.m)
...
*Examples*: [maintaining style](src/maintainingStyle.m)
...
*Examples*: [objective-c types](src/objectiveCTypes.m)
...
*Examples*: [booleans](src/booleans.m)
...
*Examples*: [asterisk position](src/asteriskPosition.m)
...
*Examples*: [use properties](src/useProperties.m)
...
*Examples*: [accessing variables](src/accessingVariables.m)

*Reasoning*: Accessing properties using self.variable ensures that you will get through its accessor method to get the corresponding value. Accessing variables using _variable (i.e. its ivar value) skips calling its accessor, which is not correct from an object oriented perspective.
...
*Examples*: [atomicity](src/atomicity.m)
...
*Examples*: [weak-strong](src/weakStrong.m)
...
*Examples*: [conditions](src/conditions.m)
...
*Examples*: [use braces](src/useBraces.m)
...
*Examples*: [redundant comparisons](src/redundantComparisons.m)
...
*Examples*: [objective-c enums](src/objectiveCEnums.m)
...
*Examples*: [unknown value](src/unknownValue.m)
...
*Examples*: [prefix types](src/prefixTypes.m)
...
*Examples*: [constants](src/constants.m)
...
*Examples*: [prefix constants](src/prefixConstants.m)
...
*Examples*: [uppercase constants](src/uppercaseConstants.m)
...
*Examples*: [cell constants](src/cellConstants.m)
...
*Examples*: [literals](src/literals.m)
...
*Examples*: [dot notation](src/dotNotation.m)
...
*Examples*: [nullifiers](src/nullifiers.m)
...
*Examples*: [imports](src/imports.m)
...
*Examples*: [class prefixes](src/classPrefixes.m)
...
*Examples*: [UI naming](src/namingUI.m)
...
*Examples*: [delegate naming](src/delegateNaming.m)
...
*Examples*: [delegate methods](src/delegateMethods.m)
...
*Examples*: [method keywords](src/methodKeywords.m)

*Reasoning*: Method intention is more clear. You might realize what the method does without even looking into its implementation.
...
*Examples*: [return keyword](src/returnKeyword.m)

*Reasoning*: Method intention is more clear. You realize at a glance what the method is expected to return.
...
*Examples*: [no ib-action](src/noIBAction.m)
...
*Examples*: [model dictionaries](src/modelDictionaries.m)
...
*Examples*: [variables initialization](src/variablesInitialization.m)
...
*Examples*: [template code](src/templateCode.m)
...
*Examples*: [checking delegates](src/checkingDelegates.m)
...
*Examples*: [happy path](src/happyPath.m)

*Reasoning*: Nesting if statements makes the code more difficult to keep track of when reading it.
